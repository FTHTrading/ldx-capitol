...
| [`tools/migration/`](./tools/migration/) | Operator tooling (not published): PowerShell scripts that consolidate all LD Capital / LDX files onto the SanDisk with a hash-verified, cumulative manifest |
